...
const Product_buy_check = ({ image_path, design_path, type_name, color_name, product_price }: Props) => {
    ...
    return (
        <>
            ...
            <Image className={styles.bgImage} src={image_path} alt="スマホ" width={250} height={400} objectFit='contain' />
            ...
            <div className={styles.product_info}>
                ...
                <div className={styles.choseQuantity}>
                    ...
                    <span className={styles.quantity}><p className={styles.number}>{count}</p></span>
